...
var qa = V(() => {
	...
	qn = (t, e) => {
		...
		return d === "RGBA" ? new De("float32", p, [
			1,
			4,
			r,
			n
...
var Xa = V(() => {
	...
	Qa = (t) => {
		...
		switch (t.location) {
			case "cpu": return new De(t.type, t.data, e);
	...
	us && (self.onmessage = (t) => {
		...
		try {
			switch (e) {
				...
				case "end-profiling": Dr(r), postMessage({ type: e });
			}
		} catch (n) {
			postMessage({
				type: e,
...
`));
		...
		let a = function(l) {
			try {
				...
				if (f === "load") {
					...
					})(h.Rc), Bn(h.Rc, 0, 0, 1, 0, 0), Go(), In(h.Rc), R || (Mi(), R = !0);
					try {
						np(h.Md, h.bd);
					} catch (w) {
						if (w != "unwind") throw w;
	...
	var N, F, q, X, B, L, Q, Y, Z, te, ae, le = !1;
	function Me() {
		var a = ht.buffer;
	...
	var pi = (a, l, h) => {
		switch (l) {
			...
			case 4: return h ? (f) => (v(), B)[f >>> 2 >>> 0] : (f) => (v(), L)[f >>> 2 >>> 0];
	...
	function hp(a, l, h, f, w) {
		...
		lt(a, {
			name: l,
			Oc: C,
			Vc: (P, D) => (typeof D == "number" && (D = BigInt(D)), D),
			Uc: pi(l, h, !f),
			Wc: null
		});
	}
			...
			if (bt === 0) {
				...
				l((w = 0) => {
					if (!A && (hi = w, h = !0, f)) {
						...
						if (!et) {
							var D = En;
							D && (En = null, (w ? D.reject : D.resolve)(C), P = !0);
						}
						if (w && !P) throw C;
					}
	...
	function Kp(a, l, h) {
		...
		switch (a = C.map((H, K) => {
			...
			case 3:
				D = "";
				break;
			case 1: P.getStringOrSymbol = yr, D = "toValue(handle)[getStringOrSymbol(methodName)]";
		}
  ...
  ${D}
	...
	function am(a, l) {
		a = -9007199254740992 > a || 9007199254740992 < a ? NaN : Number(a), l >>>= 0, a = /* @__PURE__ */ new Date(1e3 * a), (v(), B)[l >>> 2 >>> 0] = a.getUTCSeconds(), (v(), B)[l + 4 >>> 2 >>> 0] = a.getUTCMinutes(), (v(), B)[l + 8 >>> 2 >>> 0] = a.getUTCHours(), (v(), B)[l + 12 >>> 2 >>> 0] = a.getUTCDate(), (v(), B)[l + 16 >>> 2 >>> 0] = a.getUTCMonth(), (v(), B)[l + 20 >>> 2 >>> 0] = a.getUTCFullYear() - 1900, (v(), B)[l + 24 >>> 2 >>> 0] = a.getUTCDay(), a = (a.getTime() - Date.UTC(a.getUTCFullYear(), 0, 1, 0, 0, 0, 0)) / 864e5 | 0, (v(), B)[l + 28 >>> 2 >>> 0] = a;
	}
	...
	function sm(a, l) {
		a = -9007199254740992 > a || 9007199254740992 < a ? NaN : Number(a), l >>>= 0, a = /* @__PURE__ */ new Date(1e3 * a), (v(), B)[l >>> 2 >>> 0] = a.getSeconds(), (v(), B)[l + 4 >>> 2 >>> 0] = a.getMinutes(), (v(), B)[l + 8 >>> 2 >>> 0] = a.getHours(), (v(), B)[l + 12 >>> 2 >>> 0] = a.getDate(), (v(), B)[l + 16 >>> 2 >>> 0] = a.getMonth(), (v(), B)[l + 20 >>> 2 >>> 0] = a.getFullYear() - 1900, (v(), B)[l + 24 >>> 2 >>> 0] = a.getDay();
...
`))[0] == "Error" && f.shift(), Ci(f);
	...
	var Di, Mi, vr, tt, Qt, Bn, Ri, Ui, Ni, Dn, Vi, Li, ce, Yt, Wi, ue, Mn, de, Gi, Rn, Hi, Fi, qi, Un, Ki, ji, Zi, Qi, Yi, Xi, Ji, ea, ta, ra, na, oa, ia, aa, sa, ua, da, la, ca, pa, ma, fa, ha, ga, ba, ya, _a, wa, va, $a, xa, Sa, Ta, Ia, Ca, Aa, Ea, ka, Pa, ct, Im = [
		lr,
		Vo,
		jo,
		Jo,
		...
		1007108: (a, l, h, f, w) => {
			e.$b("ReduceMean", a, {
				keepDims: !!l,
				noopWithEmptyAxes: !!h,
				axes: f ? Array.from((v(), B).subarray(Number(f) >>> 0, Number(w) >>> 0)) : []
			});
		},
		1007283: (a, l, h, f, w) => {
			e.$b("ReduceMax", a, {
		...
		1009306: (a, l, h, f, w, C, P, D, H, K, se, pe, xe, Ie, yt) => {
			e.$b("ConvTranspose", a, {
				...
				strides: [D],
				wIsConst: () => !!(v(), N)[K >>> 0],
				outputPadding: se ? Array.from((v(), B).subarray(Number(se) >>> 0, Number(pe) >>> 0)) : [],
				outputShape: xe ? Array.from((v(), B).subarray(Number(xe) >>> 0, Number(Ie) >>> 0)) : [],
				activation: Ae(yt)
			});
		},
		1009739: (a, l, h, f, w, C, P, D, H, K, se, pe, xe, Ie) => {
			e.$b("ConvTranspose", a, {
				format: D ? "NHWC" : "NCHW",
				autoPad: l,
				dilations: Array.from((v(), B).subarray(Number(h) >>> 0, (Number(h) >>> 0) + 2 >>> 0)),
				group: f,
				kernelShape: Array.from((v(), B).subarray(Number(w) >>> 0, (Number(w) >>> 0) + 2 >>> 0)),
				pads: Array.from((v(), B).subarray(Number(C) >>> 0, (Number(C) >>> 0) + 4 >>> 0)),
				strides: Array.from((v(), B).subarray(Number(P) >>> 0, (Number(P) >>> 0) + 2 >>> 0)),
				wIsConst: () => !!(v(), N)[H >>> 0],
				outputPadding: K ? Array.from((v(), B).subarray(Number(K) >>> 0, Number(se) >>> 0)) : [],
				outputShape: pe ? Array.from((v(), B).subarray(Number(pe) >>> 0, Number(xe) >>> 0)) : [],
				activation: Ae(Ie)
			});
		},
		...
		1011585: (a, l, h, f, w, C, P, D, H, K, se, pe, xe, Ie) => {
			e.$b("AveragePool", a, {
				...
				count_include_pad: f,
				storage_order: w,
				dilations: C ? Array.from((v(), B).subarray(Number(C) >>> 0, Number(P) >>> 0)) : [],
				kernel_shape: D ? Array.from((v(), B).subarray(Number(D) >>> 0, Number(H) >>> 0)) : [],
				pads: K ? Array.from((v(), B).subarray(Number(K) >>> 0, Number(se) >>> 0)) : [],
				strides: pe ? Array.from((v(), B).subarray(Number(pe) >>> 0, Number(xe) >>> 0)) : []
			});
		},
		1012064: (a, l) => {
			e.$b("GlobalAveragePool", a, { format: l ? "NHWC" : "NCHW" });
		...
		1014255: (a, l, h, f, w) => {
			e.$b("Split", a, {
				axis: l,
				numOutputs: h,
				splitSizes: f ? Array.from((v(), B).subarray(Number(f) >>> 0, Number(w) >>> 0)) : []
			});
		},
		1014411: (a) => {
			e.$b("Expand", a, void 0);
		...
		1014694: (a, l, h, f, w, C, P, D, H, K, se) => {
			e.$b("Resize", a, {
				antialias: l,
				axes: h ? Array.from((v(), B).subarray(Number(h) >>> 0, Number(f) >>> 0)) : [],
				coordinateTransformMode: Ae(w),
				cubicCoeffA: C,
				excludeOutside: P,
				extrapolationValue: D,
		...
		1015056: (a, l, h, f, w, C, P) => {
			e.$b("Slice", a, {
				starts: l ? Array.from((v(), B).subarray(Number(l) >>> 0, Number(h) >>> 0)) : [],
				ends: f ? Array.from((v(), B).subarray(Number(f) >>> 0, Number(w) >>> 0)) : [],
				axes: C ? Array.from((v(), B).subarray(Number(C) >>> 0, Number(P) >>> 0)) : []
			});
		},
		1015320: (a) => {
			e.$b("Tile", a, void 0);
		...
		1015734: (a, l, h, f, w) => {
			e.$b("Pad", a, {
				mode: l,
				value: h,
				pads: f ? Array.from((v(), B).subarray(Number(f) >>> 0, Number(w) >>> 0)) : []
			});
		},
		1015877: (a, l, h, f, w, C) => {
		...
		1016827: (a, l, h, f, w, C, P, D, H) => {
			e.$b("Attention", a, {
				...
				scale: w,
				doRotary: C,
				qkvHiddenSizes: P ? Array.from((v(), B).subarray(Number(D) >>> 0, Number(D) + P >>> 0)) : [],
		...
		1017271: (a, l, h, f, w, C, P, D, H, K, se, pe, xe, Ie, yt, Vn) => {
			e.$b("Conv", a, {
				format: pe ? "NHWC" : "NCHW",
				auto_pad: l,
				dilations: h ? Array.from((v(), B).subarray(Number(h) >>> 0, Number(f) >>> 0)) : [],
				group: w,
				kernel_shape: C ? Array.from((v(), B).subarray(Number(C) >>> 0, Number(P) >>> 0)) : [],
				pads: D ? Array.from((v(), B).subarray(Number(D) >>> 0, Number(H) >>> 0)) : [],
				strides: K ? Array.from((v(), B).subarray(Number(K) >>> 0, Number(se) >>> 0)) : [],
...
var nt = V(() => {
	...
	Bf = [
		...
		let r = rr(t);
		r >= rr(Is) && Df(r, typeof e == "function" ? e() : e);
	}, ie = (...t) => {
		Cs && Mf(...t);
	};
});
...
var Ds = V(() => {
	...
	}, Rf = 1, ks = () => Rf++, Uf = /* @__PURE__ */ new Map([
		["int8", "int32"],
		["uint8", "int32"],
		["uint32", "int32"],
		["int64", "int32"]
...
var oe = V(() => {
  ...
  fn get_${t}(${M}) -> ${p} {
    return get_${t}ByIndices(${v(G)});
			...
			let G = M.map(y).join(",");
			return s === 0 ? B("0u") : s === 1 ? B(G[0]) : (b.get = !0, b.getByIndices = !0, b.indicesToOffset = !0, `get_${t}(${G})`);
		}, Z = (M) => s < 2 ? B(M) : (b.getByIndices = !0, b.indicesToOffset = !0, `get_${t}ByIndices(${M})`), te = s < 2 ? "" : `
...
var nu = V(() => {
	...
	Kf = {
       ...
       `, b = (_) => `
		...
		c.length > 0 && (d = t.compute(Be(t.inputs[0], c), {
			inputs: [0],
			outputs: [-1]
    ...
    if (global_id.y < uniforms.M && global_id.x < total_sequence_length) {
      ...
      var sum: f32 = ${(() => {
		...
		let E = (A) => {
			...
			return `
  const TILE_SIZE = ${_}u;
  var<workgroup> tileQ: array<${z.type.value}, 144>;
  var<workgroup> tileV: array<${z.type.value}, 144>;
  ${A.registerUniforms([
				{
					name: "M",
					type: "u32"
   ...
   if (m < uniforms.M && n < uniforms.N) {
     ...
     output[outputIdx] = value;
		...
		let r = [
			...
			return `
  const TILE_SIZE = ${s}u;
  var<workgroup> tileInput: array<${$}, 144>;
  var<workgroup> tileWeightQ: array<${$}, 144>;
  var<workgroup> tileWeightK: array<${$}, 144>;
  var<workgroup> tileWeightV: array<${$}, 144>;
  ${m.registerUniforms([
				{
					name: "M",
					type: "u32"
...
var Od = V(() => {
	...
	Wh = (t) => {
		...
		let [g, , y, b, _] = e, [T, x, $] = Ad(r), [S, I, E] = Ad(n), A = un(y, S), z = un(b, I), v = un(_, E), { padInfo: R, outDepth: N, outHeight: F, outWidth: q } = Hh(o, d, c, p, T, x, $, A, z, v), X = i ? g * m : g, B = [
			0,
			0,
			0,
			0,
...
var Rd = V(() => {
	...
	Fh = (t, e, r, n, o, i) => {
		...
		if (r.group !== 1) {
			let A = [e[0]];
			if (o) {
				let v = t.kernelCustomData.wT ?? t.compute(Be(e[1], xo), {
					inputs: [1],
		...
		if (_ || p === 1 && m === 1 && r.dilations[0] === 1 && r.dilations[1] === 1 && r.strides[0] === 1 && r.strides[1] === 1 && r.pads[0] === 0 && r.pads[1] === 0) {
			let A = i[0], z, v, R, N = [];
			if (o) {
				let X = t.kernelCustomData.wT ?? t.compute(Be(e[1], xo), {
					inputs: [1],
					outputs: [r.wIsConst ? -2 : -1]
				})[0];
		...
		let T = !0, x = t.kernelCustomData.wT ?? t.compute(Be(e[1], xo), {
			inputs: [1],
			outputs: [r.wIsConst ? -2 : -1]
		})[0];
...
var Nd = V(() => {
	...
	Ud = (t, e, r) => {
		...
		let R = (N) => {
			...
			], q = we(t[0].dataType), X = i ? 1 : 2, B = i ? 2 : 3, L = i ? 3 : 1, Q = O("W", t[1].dataType, t[1].dims.length, _), Y = O("Dy", t[0].dataType, t[0].dims.length, p), Z = [Y, Q];
...
var Hd = V(() => {
	...
	Zh = (t, e, r, n, o, i) => (t - 1) * e + r + (n - 1) * o + 1 - i, Qh = (t, e, r, n, o) => {
		...
		let o = t.kernelCustomData.wT ?? t.compute(Be(e[1], [
			2,
			3,
			0,
			1
      ...
      ${c.setByOffset("global_idx", wo("x_in"))}
		...
		return {
			...
			getRunData: (s) => ({
				...
				dispatchGroup: { x: Math.ceil(r / Bt / 4) }
			})
		};
	}, il = (t) => {
    ...
    qkv_with_bias[global_idx] = qkv[global_idx] + bias[bias_offset_idx];
		...
		if (s && k.size(s.dims) > 0) {
			...
			return d = Pg(t, i, s, e, n, r * o, u), d = d.reshape([
				...
				r,
				o
			]), r === 1 || n === 1 ? d : t.compute(Be(d, Tl.perm), {
				inputs: [d],
				outputs: [-1]
			})[0];
	...
	Mg = (t, e) => {
		...
		return {
			...
			getRunData: () => ({
				...
				dispatchGroup: { x: Math.ceil(k.size(g) / Bt) },
				programUniforms: b
			})
		};
	}, kl = (t, e) => {
...
var Ml = V(() => {
  ...
  ${$.mainStart(g)}
    ...
    if (local_idx == 0) {
      ...
      output[workgroup_index] = vec2f(channel_scale, channel_shift);
		...
		let n = e[0].dims, o = n, i = 2, s = n[0], u = n[1], d = k.sizeFromDimension(n, i), c = fe(d), p = k.size(o) / c, m = Bl(t, e[0], e[1], e[2], s, d, u, r.epsilon), g = [
			s,
			u,
			d / c
  ...
  ${T.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
      ...
      ${S.setByOffset("global_idx", "value")};
		...
		g = g && n[n.length - 1] !== 1;
		let b = g ? t.compute(Be(t.inputs[0], y), {
			inputs: [t.inputs[0]],
			outputs: [-1]
		})[0] : t.inputs[0].reshape(Array.from({ length: n.length }, (x, $) => n[y[$]])), _ = Bl(t, b, e[1], e[2], i, u, s, r.epsilon), T = (x) => {
	...
	Fg = (t, e) => {
		...
		let z = (v) => {
			let R = I.length, N = O("a", t[0].dataType, R, g), F = O("b", 12, E.length, y), q = O("scales", t[2].dataType, t[2].dims.length), X = [
				...
				F,
				q
			], B = t.length === 4 ? O("zero_points", 12, t[3].dims.length) : void 0;
			B && X.push(B);
		...
		z.push(...W(N));
		let F = (q) => {
			let X = v.length, B = O("a", t[0].dataType, X, g), L = O("b", 12, R.length, y), Q = O("scales", t[2].dataType, t[2].dims.length), Y = [
				B,
				L,
				Q
...
var kc = V(() => {
	...
	zb = (t) => {
		...
		u ? (c = Array.from({ length: i }, (z, v) => v), c[s] = i - 1, c[i - 1] = s, d = t.compute(Be(r, c), {
			inputs: [r],
			outputs: [-1]
		})[0]) : d = r;
	...
	Vb = (t, e) => {
		...
		async initialize(e, r) {
			...
			let n = [], o = {
				...
				requiredFeatures: n
			}, i = (d) => r.features.has(d) && n.push(d) && !0;
...
var Wc = V(() => {
	...
	ur = class t {
		...
		getFloat32Array() {
			...
			return e === 0 ? /* @__PURE__ */ new Float32Array() : new Float32Array(this.module.HEAP8.buffer, this.data, e);
		}
		getBigInt64Array() {
			if (this.dataType !== 7) throw new Error("Invalid data type");
			let e = k.size(this.dims);
			return e === 0 ? /* @__PURE__ */ new BigInt64Array() : new BigInt64Array(this.module.HEAP8.buffer, this.data, e);
		}
		getInt32Array() {
			if (this.dataType !== 6) throw new Error("Invalid data type");
			let e = k.size(this.dims);
			return e === 0 ? /* @__PURE__ */ new Int32Array() : new Int32Array(this.module.HEAP8.buffer, this.data, e);
		}
		getUint16Array() {
			if (this.dataType !== 10 && this.dataType !== 4) throw new Error("Invalid data type");
			let e = k.size(this.dims);
			return e === 0 ? /* @__PURE__ */ new Uint16Array() : new Uint16Array(this.module.HEAP8.buffer, this.data, e);
		}
		reshape(e) {
...
*/
//#endregion
export { _f as InferenceSession, Tr as TRACE, _t as TRACE_EVENT_BEGIN, wt as TRACE_EVENT_END, Ve as TRACE_FUNC_BEGIN, Re as TRACE_FUNC_END, je as Tensor, oT as default, _e as env, kt as registerBackend };
